document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'es': {
            ...
            'service-rute_detail': '<p><strong>Detalle del Servicio:</strong></p><p>El Control de Ruta Inteligente es un sistema de geolocalización que garantiza salidas en tiempo y la seguridad de la carga. Mediante notificaciones en tiempo real y un análisis detallado, verifica que las unidades sigan rutas preautorizadas y respeten las paradas seguras, identificando proactivamente los focos rojos.</p><ul><li>Rastreos satelitales con la empresa SKYGUARDIAN, lideres en geo localización.</li><li>Salidas en tiempo.</li><li>Actualización de estatus con la frecuencia que se solicite.</li><li>Notificaciones en tiempo real.</li><li>Reportes detallados de ruta.</li><li>Análisis de ruta (paradas autorizadas, focos rojos).</li><li>Comunicación Efectiva.</li></ul>',
        ...
        'en': {
            ...
            'service-rute_detail': '<p><strong>Service Details:</strong></p><p>The Smart Route Control is a geolocation system that guarantees on-time departures and cargo security. Through real-time notifications and detailed analysis, it verifies that units follow pre-authorized routes and respect safe stops, proactively identifying red flags.</p><ul><li>Satellite tracking with SKYGUARDIAN, leaders in geolocation.</li><li>On-time departures.</li><li>Status updates at the requested frequency.</li><li>Real-time notifications.</li><li>Detailed route reports.</li><li>Route analysis (authorized stops, red flags).</li><li>Effective communication.</li></ul>',
